...
<<<<<<< HEAD
    ...
    st.subheader("📈 Backtest Institucional")

    trades, equity_curve = executar_backtest(
    ...
    if not trades.empty:
        ...
        fig_equity.update_layout(
            ...
            title="Equity Curve Institucional",
        ...
        st.warning(
            "Nenhuma operação encontrada no backtest."
        )
